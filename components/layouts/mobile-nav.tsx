                        ...
                        return (
                            <React.Fragment key={item.title}>
                                {isActive ? (
                                    ...
                                    <Link
                                        href={item.link}
                                        className={`inline-flex flex-col items-center justify-center px-5 ${index === menu.length - 1 ? 'rounded-e-full' : ''} ${index === 0 ? 'rounded-s-full' : ''} group hover:bg-gray-50 dark:hover:bg-gray-800`}
                                    >
