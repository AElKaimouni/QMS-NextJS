...
export default function HomePanel() {
    ...
    return (
        <div className="flex h-full w-full flex-col justify-center gap-4 sm:flex-row sm:flex-wrap">
            ...
            <div className="w-full max-w-[19rem] rounded border border-[#e0e6ed] bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
                <div className="px-6 py-7">
                    <div className="mb-5 inline-block rounded-full bg-[#3b3f5c] p-3 text-[#f1f2f3]">{/* <svg> ... </svg> */}</div>
